        ...
        <div className="bg-estate-primary text-white py-20">
          <div className="container-custom">
            ...
            <p className="text-xl max-w-3xl">
              Get in touch with our team of experts. We're here to help with all your real estate needs.
            </p>
          </div>
        </div>
                  ...
                  <CardContent className="pt-6">
                    ...
                    <div className="space-y-6">
                      <div className="flex items-start">
                        <div className="bg-estate-primary/10 p-3 rounded-full mr-4 text-estate-primary">
                          <MapPin size={24} />
                        </div>
                        <div>
                          <h3 className="font-semibold mb-1">Our Office</h3>
                          <p className="text-gray-600">123 Estate Street, Real City, State 12345</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">info@estateelegance.com</p>
                        </div>
                      </div>
                    ...
                    <div className="mt-8">
                      ...
                      <div className="flex space-x-4">
                        <a href="#" className="bg-estate-primary/10 p-2 rounded-full text-estate-primary hover:bg-estate-primary hover:text-white transition-colors">
